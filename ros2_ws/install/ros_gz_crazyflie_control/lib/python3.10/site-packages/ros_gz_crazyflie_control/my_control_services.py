...
class ControlServices(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('robot_prefix', 'crazyflie')  # No leading slash
        self.declare_parameter('incoming_twist_topic', 'cmd_vel')  # No leading slash
        ...
        # Use relative topic names so namespace from launch file is respected
        self.publisher_ = self.create_publisher(Twist, incoming_twist_topic, 10)
