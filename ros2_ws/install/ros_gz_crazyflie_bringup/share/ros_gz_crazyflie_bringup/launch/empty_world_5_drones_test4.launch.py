    ...
    for i in range(5):
        bridge_nodes.append(
            Node(
                ...
                name=f'ros_gz_bridge_{i}',  # Unique name for each bridge
                namespace=f'crazyflie{i}',  # Optional: put bridge in drone's namespace
                parameters=[{
        ...
        control_nodes.append(
            Node(
                ...
                executable='my_control_services',
                ...
                parameters=[{
                    ...
                    'robot_index': i,
                    'robot_prefix': '',  # <--- Set to empty string!
                }],
                output='screen'
            )
        )
